...
async def get_access_token(request: PlaidPublicTokenIn):
    global access_token
    global item_id
    global transfer_id
...
@router.get("/transactions", response_model=None, response_model_exclude_none=True)
...
@router.get('/balance', response_model=None, response_model_exclude_none=True)
def get_balance():
    try:
